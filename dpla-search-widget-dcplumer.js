var DPLAWidgetConfig = {
            css_href: 'http://www.dcplumer.com/dpla/dpla-search-widget-dcplumer.css',
...
;(window.onload = function() {
    ...
    form.name = 'dpla_search_widget_dcplumer';
    form.target = '_blank';
    ...
    var search_div = document.getElementById("dpla_search_widget_dcplumer");
